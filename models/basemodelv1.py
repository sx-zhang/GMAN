...
class BaseModelv1(torch.nn.Module):
    def __init__(self, args):
        ...
        self.img_linear_0 = nn.Linear(512, 32)
    ...
    def embedding(self, state, target, action_probs, params, att):
        ...
        if params is None:
            ...
            fake_reshaped = img_info.view(1, 32, 7, 7)
    ...
    def forward(self, model_input, model_options):
        ...
        x, image_embedding = self.embedding(state, target, action_probs, params, att_episode)
