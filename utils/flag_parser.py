...
def parse_arguments():
    ...
    parser.add_argument(
        ...
        type=str,
        default="unseen",
        help="Which type of object. Choices are seen or unseen.",
    )
    parser.add_argument(
        "--fine_tuning",
        type=str,
        default=None,
        help="train base given model dir",
    )
    parser.add_argument(
        "--G_grad",
        type=bool,
        default=False,
        help="If true, the G will be trained",
    )
    parser.add_argument(
        "--D_grad",
        type=bool,
        default=False,
        help="If true, the D will be trained",
    )
    parser.add_argument(
        "--num_steps",
        type=int,
