...
from runners import nonadaptivea3c_train, nonadaptivea3c_val, gman_train, gman_val
...
def main():
    ...
    if args.model == "BaseModel":
        ...
        args.num_steps = 20
        target = gman_val if args.eval else gman_train
    ...
    if args.fine_tuning is not None:
        ...
        #         if layer.startswith('conv1') or layer.startswith('embed'):
        #             print(layer)
